...
import CommentsList from "./shared/commentSection/commentsList/CommentList";
              ...
              >
                ...
                <Grid item xs={12}>
                  <Card sx={{ boxShadow: "none" }}>
                    <Button
                      onClick={() =>
                        navigate(`/authors/${data.post.author.slug}`)
                      }
                    >
                      <CardHeader
                        avatar={
                          data.post.cover.url ? (
                            ...
                            <Avatar
                              ...
                              aria-label="recipe"
                            >
                              {data.post.author.name.split("")[0]}
                            </Avatar>
                          )
                        }
                        title={
                          <Typography fontWeight={500} color="grey.800">
                            نویسنده: {data.post.author.name}
                          </Typography>
                        }
                        subheader={
                          <Typography
                          ...
                          >
                            {solarDateConvertor(
                              ...dateSeprator(data.post.updatedAt)
                            )}
                          </Typography>
                        }
                      />
                ...
                >
                  <img
                    ...
                    alt="cover"
                    loading="lazy"
                    style={{ maxWidth: "90%", height: "auto", minWidth: "50%" }}
                  />
                </Grid>
                <Grid item xs={12}>
                  <div
